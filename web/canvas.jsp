<%-- 
    Document   : canvas
    Created on : Dec 13, 2015, 3:34:01 PM
      ...
      <div class="products">
        ...
        <form action="login.jsp" method="post">
            <table>
                <tr>
                    <td>
                <center><input type="checkbox" name="c1" value="52.99$"></center><br><img src="css/images/canvas7.jpg" alt="" width="231" height="300" /><br><br>
                <center><b> Wine-glass Wall Clock in 3pcs </b><br>
                <strong class="price"> USD  52.99$</strong></center></td>
                     <td>
                     <center><input type="checkbox" name="c2" value="52.99$"></center><br><img src="css/images/canvas2.jpg" alt="" width="231" height="300" /><br><br>
                     <b>The Callas Clock in Canvas 3pcs</b><br>
                     <center> <strong class="price">  USD   52.99$</strong></center></td>
                     <td>
                     <center><input type="checkbox" name="c3" value="82.99$"></center><br><img src="css/images/canvas3.jpg" alt="" width="231" height="300" /><br><br>
                     <b>Botanical Canvas Wall Clock in 3pcs</b><br>
                        <center><strong class="price"> USD  82.99$</strong></center></td>
                </tr>
                <tr>
                    <td><br><br>
                <center><input type="checkbox" name="c4" value="39.99$"></center><br><img src="css/images/canvas4.jpg" alt="" width="231" height="300" /><br><br>
                <center><b>Country Style Wall Clock-2pcs </b><br>
                 <strong class="price"> USD   39.99$</strong></center></td>
                    <td><br><br>
                    <center><input type="checkbox" name="c5" value="135.99$"></center><br><img src="css/images/canvas5.jpg" alt="" width="231" height="300" /><br><br>
                    <center><b> White Horse Wall Clock in 5pcs</b><br>
                     <strong class="price"> USD   135.99$</strong></center></td>
                     <td><br><br>
                        <center><input type="checkbox" name="c6" value="43.99$"></center><br><img src="css/images/canvas6.jpg" alt="" width="231" height="300" /><br><br>
                           <center><b> Modern Maple Leaf Wall Clock in 3pcs</b><br>
                           <strong class="price">  USD   43.99$</center></strong></td>
                </tr>
                <tr>
