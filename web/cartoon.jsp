<%-- 
    Document   : cartoon
    Created on : Dec 13, 2015, 3:36:59 PM
      ...
      <div class="products">
        ...
        <form action="login.jsp" method="post">
            <table>
                <tr>
                    <td>
                <center><input type="checkbox" name="c1" value="35.59$"></center><br><img src="css/images/cartoon1.jpg" alt="" width="231" height="300" /><br><br>
                <center><b>Cartoon Dog Wall Clock</b><br>
                <strong class="price"> USD  35.59$</strong></center></td>
                     <td>
                     <center><input type="checkbox" name="c2" value="48.84$"></center><br><img src="css/images/cartoon2.jpg" alt="" width="231" height="300" /><br><br>
                     <b>Children's Room Wall Clock</b><br>
                     <center> <strong class="price">  USD   48.84$</strong></center></td>
                     <td>
                     <center><input type="checkbox" name="c3" value="89.70$"></center><br><img src="css/images/cartoon3.jpg" alt="" width="231" height="300" /><br><br>
                     <b>Cartoon Alpaca Polyresin Wall Clock </b><br>
                        <center><strong class="price"> USD  89.70$</strong></center></td>
                </tr>
                <tr>
                    <td><br><br>
                <center><input type="checkbox" name="c4" value="69.48$"></center><br><img src="css/images/cartoon4.jpg" alt="" width="231" height="300" /><br><br>
                <center><b>Tiger Wooden Round Wall Clock</b><br>
                 <strong class="price"> USD   69.48$</strong></center></td>
                    <td><br><br>
                    <center><input type="checkbox" name="c5" value="64.84$"></center><br><img src="css/images/cartoon5.jpg" alt="" width="231" height="300" /><br><br>
                    <center><b> Lotus Leaf and Frogs Wall Clock </b><br>
                     <strong class="price"> USD   64.84$</strong></center></td>
                     <td><br><br>
                        <center><input type="checkbox" name="c6" value="30.99$"></center><br><img src="css/images/cartoon6.jpg" alt="" width="231" height="300" /><br><br>
                           <center><b>Bird Stainless Steel Wall Clock</b><br>
                           <strong class="price">  USD   30.99$</center></strong></td>
                </tr>
                <tr>
