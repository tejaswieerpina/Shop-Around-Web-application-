<%-- 
    Document   : vintage
    Created on : Dec 13, 2015, 2:45:06 PM
      ...
      <div class="products">
        ...
        <form action="login.jsp" method="post">
            <table>
                <tr>
                    <td>
                <center><input type="checkbox" name="c1" value="28.99$"></center><br><img src="css/images/vintage1.jpg" alt="" width="231" height="300" /><br><br>
                <b>15" Country Style Vintage Wall Clock</b><br>
                <center><strong class="price"> USD  28.99$</strong></center></td>
                     <td>
                     <center><input type="checkbox" name="c2" value="85.99$"></center><br><img src="css/images/vintage2.jpg" alt="" width="231" height="300" /><br><br>
                     <b>Euro Country Wall Clock</b><br>
                     <center> <strong class="price">  USD   85.99$</strong></center></td>
                     <td>
                     <center><input type="checkbox" name="c3" value="81.99$"></center><br><img src="css/images/vintage3.jpg" alt="" width="231" height="300" /><br><br>
                     <b> E-HOME Bicycle Style Metal Wall Clock</b><br>
                        <center><strong class="price"> USD  81.99$</strong></center></td>
                </tr>
                <tr>
                    <td><br><br>
                <center><input type="checkbox" name="c4" value="116.99$"></center><br><img src="css/images/vintage4.jpg" alt="" width="231" height="300" /><br><br>
                <center><b>Vintage Peacock Clock</b><br>
                 <strong class="price"> USD   116.99$</strong></center></td>
                    <td><br><br>
                    <center><input type="checkbox" name="c5" value="24.99$"></center><br><img src="css/images/vintage5.jpg" alt="" width="231" height="300" /><br><br>
                    <center><b>  Country Floral Wall Clock</b><br>
                     <strong class="price"> USD   24.99$</strong></center></td>
                     <td><br><br>
                        <center><input type="checkbox" name="c6" value="39.59$"></center><br><img src="css/images/vintage6.jpg" alt="" width="231" height="300" /><br><br>
                           <center><b> 20" Country Style Metal Wall Clock </b><br>
                           <strong class="price">  USD   39.59$</center></strong></td>
                </tr>
                <tr>
      ...
      <div class="box categories">
        ...
        <div class="box-content">
          <ul>
            ...
            <li><a href="vintage.jsp" class="active">Vintage Wall Clocks</a></li>
